...
const statusStyles: {[key: string] : string} = {
    ...
    onHold: 'border-t-amber-400',
    inProgress: 'border-t-blue-500',
    underReview: 'border-t-rose-600',
        ...
        <div className='flex gap-5 overflow-x-scroll 2xl:overflow-auto pb-32'>
            ...
            {Object.entries(groupedTasks).map(([status, tasks]) => (
                <div key={status} className='min-w-[300px] 2xl:min-w-0 2xl:w-1/5'>
                    <h3 
                        className={`bg-gradient-to-b from-blue-50 via-purple-50 to-indigo-50 capitalize text-xl font-light border border-slate-300 p-3 border-t-8 ${statusStyles[status]}`}
                    >
